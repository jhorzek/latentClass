...
latentClass is an R package that provides a vanilla implementation of latent class models with continuous variables (Gaussian) and categorical variables. The main purpose
was to learn how latent class models work. For practical purposes, use one of the established packages:
...
latentClass handles missing data by means of full information maximum likelihood (see Vermunt et al., 2013).
